...
#define DI_NIVXI_VXIMOVE_METHOD  (0x8107)
#define DI_NIVXI_WS_TMO_RES      (0x8108)
#define DI_NIVXI_MAP_RETRY_IMPL  (0x8109)
#define DI_NIVXI_KRNL_IN8_ADDR   (0x810A)
#define DI_NIVXI_KRNL_IN16_ADDR  (0x810B)
#define DI_NIVXI_KRNL_IN32_ADDR  (0x810C)
#define DI_NIVXI_KRNL_OUT8_ADDR  (0x810D)
#define DI_NIVXI_KRNL_OUT16_ADDR (0x810E)
#define DI_NIVXI_KRNL_OUT32_ADDR (0x810F)
#define DI_NIVXI_RESMAN_STATUS   (0x8110)
#define DI_NIVXI_VXI_TO_CPU_BASE		(0x8111)
#define DI_NIVXI_VXI_TO_CPU_SIZE		(0x8112)
#define DI_NIVXI_VXI_TO_IOPORT_BASE	(0x8113)
#define DI_NIVXI_VXI_TO_IOPORT_SIZE	(0x8114)
#define DI_NIVXI_NUMBER_USER_WINDOWS (0x8115)
#define DI_NIVXI_VISA_FUNC_ADDRS (0x8116)
#define DI_NIVXI_LA_LIST         (0x8117)
#define DI_NIVXI_IS_SPY_ENABLED  (0x8118)
#define DI_NIVXI_ENABLE_NI_SPY   (0x8119)
#define DI_NIVXI_BOARDREGWINBASE (0x8120)
...
#define INIT_RET_OK_RMERROR      ( 2)        /* Resource manager did not run or failed */
