...
#define WSb_RET_END          (1U<<1)   /* END or TermChar was received on Read */
#define WSb_RET_TC           (1U<<2)   /* Terminal Count--buffer was filled    */
#define WSb_RET_DirDorAbort  (1U<<3)   /* Device was !DIR(writes), !DOR(reads) */
#define WSb_RET_EOI          (1U<<4)   /* END Bit Received on transfer         */
#define WSb_RET_EOS          (1U<<5)   /* TermChar Received on transfer        */
