...
#include <basetsd.h>
/* even newer versions of the SDK include all the UINT_ and INT_TYPES defines below */
...
#if (defined(VXISOLARIS))
/* We need the _LP64/_ILP32 macros from sys/types.h */
#include <sys/types.h>
#endif
...
#if defined (_LP64) /* LP64 is the data model used by 64-bit Solaris 7 */
typedef	         int       INT32;
#else /* not LP64 */
...
typedef unsigned long   BUS_ADDRESS;
